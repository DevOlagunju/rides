...
export const createUser = (req, res) => {
    ...
    if (!errors.isEmpty()) {
        ...
        bcrypt.hash(password, saltRounds, (err, hash) => {
            client.query('INSERT INTO users (first_name,last_name,email,phone_no,password) VALUES ($1, $2, $3, $4, $5)RETURNING *',
                [first_name, last_name, email, phone_no, hash], (error, user) => {
                    if (error) {
